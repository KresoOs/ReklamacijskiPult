...
namespace Backend.Controllers
{
        ...
        public abstract class ReklamacijskiController<T, TDR, TDI>(ReklamacijskiPultContext context) : ControllerBase where T : Entitet
        {
            ...
            protected readonly ReklamacijskiPultContext _context = context;
